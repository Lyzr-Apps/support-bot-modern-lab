    ...
    <div className="min-h-screen bg-gradient-to-br from-green-400 to-green-500">
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 w-16 h-16 bg-gradient-to-br from-emerald-700 to-emerald-800 hover:from-emerald-800 hover:to-emerald-900 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center z-50"
